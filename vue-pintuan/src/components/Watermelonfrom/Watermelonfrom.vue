<template>
    <div class="Watermelonfrom">
      <mt-header  class="topBar" style="font-size: 0.4rem" title="小招周二请您吃虾蟹面">
        <div @click="closeApp" slot="left">
          <mt-button icon="back"></mt-button>
        </div>
      </mt-header>

      <img src="./img2/img1.png" class="img"  alt="">
      <img src="./img2/img2.png" class="img" alt="">
      <img src="./img2/img3.png" class="img" @click="shopping" alt="">
      <img src="./img2/img4.png"  @click="$router.push('/myOrder')" class="img" alt="">
      <img src="./img2/img5.png" class="img" alt="">
      <div class="wrap">
        <div class="infoWrap">
          <div class='codeNum' v-if="num != 0">剩余数量: <span class='num'>{{num}}</span>张</div>
          <div class="info">
            <p>当前场次: <span>2018-10-09</span></p>
            <!--<p> {{num == 0 ? '距离下场活动开始还有' : '距离本场活动结束还有'}}: <span>{{times}}</span> </p>-->
            <p>本场代金券有效期至: <span>2018-11-15</span></p>
          </div>
        </div>
