<template>
  <div class="Watermelonfrom4">
    ...
    <div class="wrap">
      <img src="./water5/img1.png" style="width: 100%;" alt="">
      <div class="infoWrap">
      ...
      <img src="./water5/img2.png" @click="shopping" class="shopping" alt="">

      <div class="btns">
        <img src="./water5/img3.png"  class="myOrderBtn" alt="">
  ...
  export default {
    ...
    methods: {
      ...
      shopping(){
        ...
        if(hours < 10 && day != 5 && day != 12 && day != 19 && day != 26){
  ...
  .Watermelonfrom4
    ...
    .wrap
      ...
      .infoWrap
        ...
        margin-left -4rem
        width 8rem
        background url('./water5/img4.png') no-repeat left top
        ...
        .codeNum
          ...
          font-size 0.35rem
          color #c82765
          border-bottom:1px dashed #c82765
          .num
