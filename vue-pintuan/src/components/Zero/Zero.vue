<template>
  <transition name="opacity">
    <div class="advertProducts">
      <!-- 顶部导航 -->
      <mt-header :fixed="true" class="topBar" style="font-size: 0.4rem" title="0元福利">
      ...
      <div style="position: relative;height:100%">
        ...
        <scroll :listenScroll="true" :listenTouchend="true" @touchEnd="downPullReload" :probeType="3" ref="scroll" @scroll="getNewData"class="scroll">
          <div class="view">
            <img src="./image/zeroBanner.jpg" style="width: 100%" class="banner" alt="">
            <!--    <div class="reload" v-show="priceList.length&&defaultList.length">下拉刷新</div>-->
            <ul  v-show="type==0">
              <li  v-for="item in defaultList"><component :is="item.activityType == 1 ? 'PreferentialListItem' :  'ProductListItem'"  :data="item" :unit="unit"></component></li>
            </ul>
...
<script type='text/javascript'>
  ...
  import  PreferentialListItem from '@/common/components/PreferentialListItem'
  ...
  export default {
    data() {
      return {
        ...
        advertId:this.$route.params.advertId ? this.$route.params.advertId : 0
      }
    },
    created(){
      if(this.siteConfig){
