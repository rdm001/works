<template>
  <div class="ZlGift2">
    ...
    <div class="content">
      <img src="./image/back.png" class="back" @click="$router.push('/zlHome2')" alt="">
            ...
            <div class="productInfo">
              <div>
                 <span style="margin-right: 0.3rem;color:#000;font-weight: bold;font-size:0.3rem">市场价:
                   <i style="text-decoration:line-through">{{item.activityProductVo.salePrice | fulterUnit}}</i>
                 </span>
                 <i style="font-size:0.4rem;color:#c8132d;font-weight: bold;">{{item.activityProductVo.floorPrice | fulterUnit}}</i>
              </div>
    ...
    methods: {
      ...
      submitAddr(){
          ...
          let obj = this.list.filter((e) => {
              return e.activityProductVo.siteProductId == 7057
          })[0]
          this.$http.post(
